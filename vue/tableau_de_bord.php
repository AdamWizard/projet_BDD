...
while($maison = $maisons->fetch_assoc()){
    ...
    <maison>
        ...
        <h4>Degré d'isolation : $degreIso</h4>
...
END;
        ...
        echo<<<END
            <!-- piece -->
            <piece>
                <h3>Pièce : $libellePiece</h3>
                <h4>Type de pièce : $libelleTypePiece</h4>
...
END;
        ...
        while($appareil = $appareils->fetch_assoc()){
            ...
            echo <<<END
                ...
                <eq>
                    <h4>Nom de l'appareil : $nom_appareil</h4>
                    
                    <h5>Type : $typeAppareil</h5>
                    <br>
                    Actuellement $statut
END;
            if($allume == 0){
