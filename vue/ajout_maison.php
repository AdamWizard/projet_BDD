...
<form method="POST" action="">
        ...
        <div>
            ...
            <input name="nom" type="text" id="idnom" placeholder="Exemple" maxlength="50" required>
        </div>
        ...
        <div>
            ...
            <input name="mdp" type="password" id="idmdp" maxlength="50" required>
        </div>

        <div>
            <label for="idmdp2">valider le mot de passe</label>
            <input name="mdp2" type="password" id="idmdp2" maxlength="50" required>
        </div>
